...
public class MergeRecyclerAdapter extends RecyclerView.Adapter {
     ...
     */
    public void addAdapter(final int index, final RecyclerView.Adapter adapter) {
     ...
     */
    public void removeAdapter(final int index) {
    ...
    public RecyclerView.Adapter getAdapter(final int index) {
    ...
    private int getAdapterStartPosition(final int index) {
        int start = 0;
    ...
    private static class ViewsViewHolder extends RecyclerView.ViewHolder {
        ViewsViewHolder(android.view.View itemView) {
            super(itemView);
        }
    }
