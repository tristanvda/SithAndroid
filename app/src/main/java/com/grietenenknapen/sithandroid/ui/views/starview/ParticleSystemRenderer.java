...
import com.pddstudio.starview.opengl.RawResourceReader;
import com.pddstudio.starview.opengl.ShaderHelper;
...
public class ParticleSystemRenderer implements GLTextureView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        final String vertexShader = RawResourceReader.readTextFileFromRawResource(appContext, com.pddstudio.starview.R.raw.star_vert);
        final String fragmentShader = RawResourceReader.readTextFileFromRawResource(appContext, com.pddstudio.starview.R.raw.star_frag);

        final int vertexShaderHandle = com.pddstudio.starview.opengl.ShaderHelper.compileShader(GLES20.GL_VERTEX_SHADER, vertexShader);
        final int fragmentShaderHandle = com.pddstudio.starview.opengl.ShaderHelper.compileShader(GLES20.GL_FRAGMENT_SHADER, fragmentShader);
